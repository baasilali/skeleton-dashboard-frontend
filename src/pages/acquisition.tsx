...
function AcquisitionBody() {
  ...
  const situationData = React.useMemo(
    () => getProspectSituationChartData(filters),
    [filters]
  );
          ...
          <div className="flex flex-1 flex-col gap-4 p-4 mt-4">
            ...
            <div className="flex flex-1 flex-col gap-4 mt-4">
              ...
              <div className="grid auto-rows-min gap-4 md:grid-cols-3">
                <InteractivePieChart title={"Funnel Breakdown"} allLabel="Select Funnel" data={funnelData} />
                <InteractivePieChart title={"Prospect Situation"} allLabel="Select Situation" data={situationData} />
