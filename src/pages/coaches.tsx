...
function CoachesBody() {
  ...
  const coachLeadsBreakdownData = React.useMemo(
    () => getCoachLeadsBreakdownChartData(filters),
    [filters]
  );
        ...
        <SidebarInset>
          ...
          <div className="flex flex-1 flex-col gap-4 p-4 mt-4">
            <div className="flex flex-1 flex-col gap-4">
              ...
              <MetricCard
                  description="Coach Commission"
                  value={currency.format(coachCommission)}
                  delta={12}
                />
                <MetricCard
            ...
            <div className="flex flex-1 flex-col gap-4 mt-4">
              ...
              <div className="grid auto-rows-min gap-4 md:grid-cols-2">
                <InteractivePieChart title={"Coach Leads Breakdown"} allLabel="Select Coach" data={coachLeadsBreakdownData} />
              </div>
            </div>
          </div>
        </SidebarInset>
